...
gsap.fromTo('.hero-bg img',{y:0,scale:1},{y:50,scale:1.08,scrollTrigger:{trigger:'.hero',start:'top top',end:'bottom top',scrub:true},ease:'none'});
...
var rosterHero=document.querySelector('.roster-hero');if(rosterHero){gsap.fromTo('.roster-hero .hero-bg img',{scale:1.1,opacity:0},{scale:1,opacity:1,duration:2,ease:'power3.out',delay:0.2});gsap.fromTo('.roster-hero .hero-bg img',{y:0,scale:1},{y:50,scale:1.08,scrollTrigger:{trigger:'.roster-hero',start:'top top',end:'bottom top',scrub:true},ease:'none'});gsap.fromTo('.roster-hero-title',{y:30,opacity:0},{y:0,opacity:1,duration:0.8,delay:0.5,ease:'power3.out'});gsap.fromTo('.roster-hero-subtitle',{y:20,opacity:0},{y:0,opacity:1,duration:0.6,delay:0.7,ease:'power2.out'})}
